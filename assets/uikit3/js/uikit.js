        ...
        methods: {
            ...
            updateNav: function updateNav() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, this$1.clsActive, index(el) === i);
    ...
    UIkit.component('slider', {
        ...
        events: {
            ...
            itemshown: function itemshown() {
                ...
                this.slides.forEach(function (slide) { return toggleClass(slide, this$1.clsActive, this$1.clsActivated, includes(actives, slide)); });
            }
